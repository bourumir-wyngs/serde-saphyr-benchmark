...
|         [serde-yml](https://crates.io/crates/serde-yml) | 0.0.12              | ⚠️ apply_merge | ❌            | ❌                       |                                                                                                       |
|      [yaml-spanned](https://crates.io/crates/yaml-spanned) | 0.0.3               | ⚠️ apply_merge | ❌            | ✅                       | Uses [libyaml-safer](https://crates.io/crates/libyaml-safer) with most of formerely unsafe code fixed |
